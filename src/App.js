...
const NewsSnippet_1 = require("./components/NewsSnippet/NewsSnippet"); // Импорт компонента
require("./App.css"); // Стили для App (можно удалить/изменить)
const App = () => {
    ...
    <div style={{
      ...
      <NewsSnippet_1.default data={newsData}/>
